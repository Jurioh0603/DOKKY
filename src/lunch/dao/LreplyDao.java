...
public class LreplyDao {
    ...
    // 댓글 추가 메서드
    public void addReply(Connection conn, Lreply replyDTO) throws SQLException {
    ...
    // 특정 글에 대한 댓글 조회 메서드
    public List<Lreply> getRepliesByBno(Connection conn, int bno) throws SQLException {
